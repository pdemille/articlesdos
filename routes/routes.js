//npm's meeting requirements in uofu 
...
var result = [];
// Assign Mongoose promise using Q promises 
mongoose.Promise = Promise;
// Mongodb models paths
var Articles = require("../models/model.js");
var Comments =require('../models/model2.js')

// Scrape the coindesk db
...
router.get('/articles', function(req, res){
    ...
    // Scrape website for title, images, link, text
